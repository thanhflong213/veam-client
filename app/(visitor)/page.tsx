        ...
        <div className="inner">
          ...
          <div className="keynote-grid">
            {[
              {
                initials: "PA",
                name: "Prof. Philippe Aghion",
                inst: "London School of Economics and Political Science",
                topic: "Innovation & Growth Economics",
              },
              {
                initials: "TKP",
                name: "Prof. Thi Kim Cuong PHAM",
                inst: "University of Paris Nanterre",
                topic: "Development Economics",
              },
              {
                initials: "MB",
                name: "Prof. Maria-Giuseppina BRUNA",
                inst: "IPAG Business School, France",
            ...
            >
              ...
              >
                TBA
                <br />
                <span style={{ fontSize: 11 }}>To be announced</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
              ...
              {[
                {
                  ...
                  desc: "5:00 PM Hanoi time (GMT+7)",
                },
                {
                  date: "Jun 15\n2026",
                  title: "Acceptance Notification",
                  desc: "Authors notified by email",
                },
                {
                  date: "Jun 16\n2026",
                  title: "Registration Opens",
                  desc: "Early bird rates available",
                },
                {
                  date: "Jun 30\n2026",
                  title: "Registration Closes",
                  desc: "Final deadline for all participants",
                },
                {
                  date: "Jul 13–14\n2026",
                  title: "Main Conference",
                  desc: "Hue University of Economics, Vietnam",
                  done: true,
                },
              ].map((item, i) => (
                <div className="tl-item" key={i}>
                  <div className="tl-date" style={{ whiteSpace: "pre-line" }}>
                    {item.date}
                  </div>
          ...
          <div>
            ...
            >
              {[
                {
                  title: "Behavioral Economics and Environment",
                  chair: "Chair: Khanh-Nam Pham, UEH, Vietnam",
                },
                {
                  title: "Development Economics",
                  chair:
                    "Chair: Quang Thanh Le, University of Wollongong, Australia",
                },
                {
                  title: "Theoretical Economics",
                  chair: "Chair: Ngoc-Sang Pham, EM Normandie, France",
                },
              ].map((s, i) => (
      ...
      >
        <div className="inner">
          <div className="section-head">
            ...
            <p>
              Selected papers from VEAM 2026 will be considered for publication
            </p>
          </div>
          <div className="pub-grid">
            {[
              {
                title: "Revue d'Économie du Développement",
                desc: "ISVE–VEAM Special Issue featuring selected conference papers",
              },
              {
                title: "Journal of International Economics and Management",
                desc: "Foreign Trade University flagship journal",
              },
              {
                title: "Review of Development Economics",
                desc: "John Wiley & Sons Ltd. peer-reviewed journal",
              },
              {
                title: "Journal of Asian Business and Economic Studies",
                desc: "Emerald Publishing international journal",
              },
            ].map((p, i) => (
      ...
      <div className="home-section">
        <div className="inner">
          ...
          <div className="org-grid">
            {[
              {
                name: "University of Economics – Hue University",
                role: "Host Institution",
              },
              { name: "Foreign Trade University", role: "Co-organizer" },
              {
                name: "DEPOCEN",
                role: "Development and Policies Research Center",
              },
              {
                name: "CNRS France",
                role: "French National Center for Scientific Research",
              },
              {
              ...
              {
                name: "ISVE",
                role: "International Society of Vietnam Economists",
              },
            ].map((org, i) => (
